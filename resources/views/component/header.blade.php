        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">List Menu</h6>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::url() == route('admin.order.page') ? 'active' : ''}}"
                        href="{{ route ('admin.order.page') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link {{Request::url() == route('customer.dashboard') ? 'active' : ''}}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::url() == route('catalog.page') ? 'active' : ''}}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::url() == route('order.page') ? 'active' : ''}}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::url() == route('manager.dashboard') ? 'active' : ''}}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{Request::url() == route('manager.inspect.page') ? 'active' : ''}}"
                        ...
                        <span class="nav-link-text ms-1">Inspect Order</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{Request::url() == route('manager.inspect.page') ? 'active' : ''}}"
                        ...
                        <span class="nav-link-text ms-1">Production Report</span>
                    </a>
                </li>
                @endif
                </li>
