    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Inspect</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Inspect</h6>
            </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <table class="table" id="customer-table-inspect">
                            <thead>
                                <tr>
                                    <th>Queue Number</th>
                                    <th>Order code</th>
...
@push('script')
    <script>
        $(document).ready(function () {
            $('#customer-table-inspect').DataTable({
                responsive: true,
                lengthMenu: [
                    [5, 25, 50, -1],
                    [10, 25, 50, 'All'],
